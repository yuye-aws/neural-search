...
public class AbstractLruCacheTests extends AbstractSparseTestBase {
    ...
    public void test_updateAccess_withNullKey() {
        ...
        assertEquals(1, testCache.accessRecencyMap.asMap().size());
    ...
    public void test_evict_withZeroAndNegativeBytes() {
        ...
        testCache.evict(0);
        assertEquals(2, testCache.accessRecencyMap.asMap().size());
    ...
    public void test_evict_untilEnoughMemoryFreed() {
        ...
        assertTrue(testCache.accessRecencyMap.asMap().isEmpty());
    ...
    public void test_evictItem() {
        ...
        assertFalse(testCache.accessRecencyMap.asMap().containsKey(key1));
        assertTrue(testCache.accessRecencyMap.asMap().containsKey(key2));
    ...
    public void test_onIndexRemoval() {
        ...
        assertFalse(testCache.accessRecencyMap.asMap().containsKey(key));
    }
